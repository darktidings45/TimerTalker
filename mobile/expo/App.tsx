...
const App: React.FC = () => {
  ...
  useEffect(() => {
    if (stopwatch.isRunning && tts.isEnabled && tts.isAvailable) {
      ...
      <SafeAreaView style={styles.container}>
        <ScrollView contentInsetAdjustmentBehavior="automatic" style={styles.scrollView}>
          ...
          <View style={styles.header}>
            <Text style={styles.title}>⏱️ Interactive Timer</Text>
          ...
          <View style={styles.timerCard}>
            ...
            <StopwatchControls
              ...
              isAudioSupported={tts.isAvailable}
          ...
          <View style={styles.infoSection}>
            <Text style={styles.infoTitle}>🚀 Expo Native Features</Text>
            <Text style={styles.infoText}>
              Built with Expo for easy development and deployment. 
              Features native text-to-speech and cross-platform compatibility.
            </Text>
          </View>
        </ScrollView>
      </SafeAreaView>
